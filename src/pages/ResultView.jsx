        ...
        <main className="relative z-10 flex flex-col items-center px-4 pt-6 pb-20 w-full max-w-lg mx-auto space-y-4">
            ...
            <div className="w-full flex flex-col items-center space-y-3 py-3">
                <div className="flex flex-wrap items-center justify-center gap-2">
                    <button className="flex items-center justify-center h-11 px-5 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold text-sm rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all">
